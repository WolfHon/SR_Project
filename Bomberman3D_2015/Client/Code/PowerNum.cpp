...
CPowerNum::CPowerNum( LPDIRECT3DDEVICE9 pDevice )
...
CPowerNum::~CPowerNum( void )
{

}

Engine::OBJECT_RESULT CPowerNum::Update( void )
{
...
CPowerNum* CPowerNum::Create( LPDIRECT3DDEVICE9 pDevice, D3DXVECTOR3 vPos)
{
	CPowerNum*	pGameObject = new CPowerNum(pDevice);
...
HRESULT CPowerNum::Initialize( D3DXVECTOR3 vPos)
{
...
HRESULT CPowerNum::AddComponent( void )
{
...
void CPowerNum::Release( void )
{

}

void CPowerNum::CalculateOrtho( void )
{
	D3DVIEWPORT9 vp;
	float fFar = 1.f;
	float fNear = 0.f;
