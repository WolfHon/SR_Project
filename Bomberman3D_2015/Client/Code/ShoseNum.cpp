...
CShoseNum::CShoseNum( LPDIRECT3DDEVICE9 pDevice )
...
CShoseNum::~CShoseNum( void )
{

}

Engine::OBJECT_RESULT CShoseNum::Update( void )
{
...
CShoseNum* CShoseNum::Create( LPDIRECT3DDEVICE9 pDevice, D3DXVECTOR3 vPos)
{
	CShoseNum*	pGameObject = new CShoseNum(pDevice);
...
HRESULT CShoseNum::Initialize( D3DXVECTOR3 vPos)
{
...
HRESULT CShoseNum::AddComponent( void )
{
...
void CShoseNum::Release( void )
{

}

void CShoseNum::CalculateOrtho( void )
{
	D3DVIEWPORT9 vp;
	float fFar = 1.f;
	float fNear = 0.f;
