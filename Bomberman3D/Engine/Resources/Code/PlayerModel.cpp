...
{	
	...
	m_vBodyPos = D3DXVECTOR3(0.f, 0.f, 0.f);
	m_vHeadPos = D3DXVECTOR3(m_vBodyPos.x, m_vBodyPos.y + 12.f, m_vBodyPos.z);
	m_vLeftArmPos = D3DXVECTOR3(m_vBodyPos.x - 6.f , m_vBodyPos.y, m_vBodyPos.z);
	m_vRightArmPos = D3DXVECTOR3(m_vBodyPos.x + 6.f, m_vBodyPos.y, m_vBodyPos.z);
	m_vLeftFootPos = D3DXVECTOR3(m_vBodyPos.x - 2.f, m_vBodyPos.y - 14.f, m_vBodyPos.z);
	m_vRightFootPos = D3DXVECTOR3(m_vBodyPos.x + 2.f, m_vBodyPos.y - 14.f, m_vBodyPos.z);

	m_vBodyScale = D3DXVECTOR3(m_fScaleSize * 2.f, m_fScaleSize *  4.f, m_fScaleSize * 1.f);
	m_vHeadScale = D3DXVECTOR3(m_fScaleSize * 2.f, m_fScaleSize * 2.f, m_fScaleSize * 2.f);
	m_vArmScale = D3DXVECTOR3(m_fScaleSize * 1.f, m_fScaleSize * 3.f, m_fScaleSize * 1.f);
	m_vFootScale = D3DXVECTOR3(m_fScaleSize * 1.f, m_fScaleSize * 3.f, m_fScaleSize * 1.f);
...
HRESULT Engine::CPlayerModel::AddComponent()
{
	...
	pComponent = Get_ResourceMgr()->CloneResource(RESOURCE_DYNAMIC, L"Texture_Player_LeftArm");
	m_pLeftArmTexture = dynamic_cast<CTexture*>(pComponent);
	NULL_CHECK_RETURN(m_pLeftArmTexture, E_FAIL);

	pComponent = Get_ResourceMgr()->CloneResource(RESOURCE_DYNAMIC, L"Texture_Player_RightArm");
	m_pRightArmTexture = dynamic_cast<CTexture*>(pComponent);
	NULL_CHECK_RETURN(m_pRightArmTexture, E_FAIL);

	pComponent = Get_ResourceMgr()->CloneResource(RESOURCE_DYNAMIC, L"Texture_Player_LeftFoot");
	m_pLeftFootTexture = dynamic_cast<CTexture*>(pComponent);
	NULL_CHECK_RETURN(m_pLeftFootTexture, E_FAIL);

	pComponent = Get_ResourceMgr()->CloneResource(RESOURCE_DYNAMIC, L"Texture_Player_RightFoot");
