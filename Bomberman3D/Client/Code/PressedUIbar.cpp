...
CPressedUIbar::CPressedUIbar( LPDIRECT3DDEVICE9 pDevice )
...
CPressedUIbar::~CPressedUIbar( void )
{

}

Engine::OBJECT_RESULT CPressedUIbar::Update( void )
{
...
void CPressedUIbar::Render( void )
{ 
...
CPressedUIbar* CPressedUIbar::Create( LPDIRECT3DDEVICE9 pDevice, D3DXVECTOR3 vPos)
{
	CPressedUIbar*	pGameObject = new CPressedUIbar(pDevice);
...
HRESULT CPressedUIbar::Initialize( D3DXVECTOR3 vPos)
{
...
HRESULT CPressedUIbar::AddComponent( void )
{
...
void CPressedUIbar::Release( void )
{

}

void CPressedUIbar::CalculateOrtho( void )
{
	D3DVIEWPORT9 vp;
	float fFar = 1.f;
	float fNear = 0.f;
...
void CPressedUIbar::Spritegauge( void )
{
