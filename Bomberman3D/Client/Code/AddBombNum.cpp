...
CAddBombNum::CAddBombNum( LPDIRECT3DDEVICE9 pDevice )
...
CAddBombNum::~CAddBombNum( void )
{

}

Engine::OBJECT_RESULT CAddBombNum::Update( void )
{
...
CAddBombNum* CAddBombNum::Create( LPDIRECT3DDEVICE9 pDevice, D3DXVECTOR3 vPos)
{
	CAddBombNum*	pGameObject = new CAddBombNum(pDevice);
...
HRESULT CAddBombNum::Initialize( D3DXVECTOR3 vPos)
{
...
HRESULT CAddBombNum::AddComponent( void )
{
...
void CAddBombNum::Release( void )
{

}

void CAddBombNum::CalculateOrtho( void )
{
	D3DVIEWPORT9 vp;
	float fFar = 1.f;
	float fNear = 0.f;
