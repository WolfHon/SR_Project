...
CShoseUI::CShoseUI( LPDIRECT3DDEVICE9 pDevice )
...
CShoseUI::~CShoseUI( void )
{

}

Engine::OBJECT_RESULT CShoseUI::Update( void )
{
...
CShoseUI* CShoseUI::Create( LPDIRECT3DDEVICE9 pDevice, D3DXVECTOR3 vPos)
{
	CShoseUI*	pGameObject = new CShoseUI(pDevice);
...
HRESULT CShoseUI::Initialize( D3DXVECTOR3 vPos)
{
...
HRESULT CShoseUI::AddComponent( void )
{
...
void CShoseUI::Release( void )
{

}

void CShoseUI::CalculateOrtho( void )
{
	D3DVIEWPORT9 vp;
	float fFar = 1.f;
	float fNear = 0.f;
